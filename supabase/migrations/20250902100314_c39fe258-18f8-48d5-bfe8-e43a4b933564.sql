-- Create storage buckets for question papers and answer sheets
INSERT INTO storage.buckets (id, name, public, file_size_limit, allowed_mime_types) 
VALUES 
  ('question-papers', 'question-papers', false, 52428800, ARRAY['application/pdf']::text[]),
  ('answer-sheets', 'answer-sheets', false, 52428800, ARRAY['application/pdf']::text[])
...
CREATE POLICY "Admins can upload answer sheets" 
ON storage.objects 
FOR INSERT 
WITH CHECK (
